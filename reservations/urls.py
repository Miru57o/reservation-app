...
urlpatterns = [
    # /reservations/ へのアクセスはカレンダーページへリダイレクト
    path('', RedirectView.as_view(pattern_name='reservations:calendar_page', permanent=False), name='index'),
    # FullCalendarをホストするHTMLページ
